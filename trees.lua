...
function simplev7.grow_tree(data, area, pos)
  ...
  add_trunk_and_leaves(data, area, pos, c_tree, c_leaves, height, 2, 8, is_apple_tree)
end

-- Jungletree

function simplev7.grow_jungle_tree(data, area , pos)
  local x, y, z = pos.x, pos.y, pos.z
  ...
  add_trunk_and_leaves(data, area, pos, c_jungletree, c_jungleleaves, height, 3, 30, false)
